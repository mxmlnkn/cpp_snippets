...
@rem "C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v5.5\bin\nvcc.exe" md5cuda.cu -o md5cuda.exe --compiler-bindir "C:\Program Files (x86)\Microsoft Visual Studio 11.0\VC\bin" --machine 32 -arch=sm_20 --compiler-options "/O2 /C /P"
